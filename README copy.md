...
New features are still being rapidly developed, therefore the master branch may be unstable. Stable versions can be found in the [releases section](https://github.com/tsfdsong/ontology/releases).
...
- Downloading a specific version from the [release section](https://github.com/tsfdsong/ontology/releases).
...
The Ontology CLI can run nodes for the MainNet, TestNet and local PrivateNet. Check out the [Ontology CLI user guide](https://github.com/tsfdsong/ontology/blob/master/docs/specifications/cli_user_guide.md) for a full list of commands.
...
Contributors to Ontology are very welcome! Before beginning, please take a look at our [contributing guidelines](CONTRIBUTING.md). You can open an issue by [clicking here](https://github.com/tsfdsong/ontology/issues/new).
