...
但很多新的功能还处于快速的开发过程中，master分支的代码可能是不稳定的，稳定的版本可以在[releases](https://github.com/tsfdsong/ontology/releases)中下载。
...
- 你也可以从[下载页面](https://github.com/tsfdsong/ontology/releases)获取.
